            ...
            <div className="grid lg:grid-cols-3 gap-4">
                <div className="bg-white w-full flex flex-col justify-center items-center">
                    ...
                    <div className="text-center w-3/5">
                        <h2 className="text-3xl font-bold mb-6">Select bike</h2>
                        <p className="font-[Rubik,sans-serif] text-[#706f7b]">WE offers abig range of vehicles for all
                        your driving needs. We have the perfect bike to meet your needs</p>
                    </div>              
                </div>
                <div className="bg-white w-full flex flex-col justify-center items-center">
                ...
                <div className="bg-white w-full flex flex-col justify-center items-center">
                    ...
                    <div className="text-center w-3/5 ">
                        ...
                        got you covered with our wide range of bikes</p>
                    </div>
