...
export default function Team(){
    ...
    const members = [
        {name: "Prabha", role: "Business Owner", image: hunt}, 
        {name: "Jega", role: "Partner", image: hunt},
               
        {name: "Spartan Karthi", role: "Partner", image: hunt},
       
        {name: "Kavin", role: "Partner", image: hunt}        
    ]
