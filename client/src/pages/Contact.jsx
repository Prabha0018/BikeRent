            ...
            <div className="container mx-auto p-6 my-24">
                <div className="grid lg:grid-cols-2 gap-10 z-20">
                    <div className="md:w-2/3 text-center">
                        ...
                        <h4 style={{cursor:"pointer"}} className="text-lg font-sans font-bold  hover:text-orange"><EmailIcon/> bikerentals@gmail.com</h4>
                        <h4 style={{cursor:"pointer"}} className="text-lg font-sans font-bold py-2 hover:text-orange"><LocationOnIcon/> coimbatore, India</h4>
                    </div>
